            ...
            <div className="row">
              <div className="col-12">
                <div className="section-title text-center">
                  <h6 className="sub-title paroller" data-paroller-factor="-.05" data-paroller-type="foreground" data-paroller-direction="horizontal">PLAY2EARN</h6>
                  <h2 className="title paroller" data-paroller-factor=".05" data-paroller-type="foreground" data-paroller-direction="horizontal">NFT PC GAMES</h2>
                </div>
            ...
            <div className="row align-items-center mb-90">
                ...
                <div className="s-about-content play_content">
                  ...
                  <p>Katana Inu came into existence because there are too many blockchain games without solid graphics, and the PC gaming space is also largely ignored by P2E developers. Additionally, conventional games don't provide a play-to-earn system for their players.</p>
                    ...
                    <div className="year_compare text-center">
                      ...
                      <h3 className="pb-10">YOU DON'T OWN THEM.</h3>
                      <div className="row justify-content-center">
                        <div className="col-md-5  box box_one pb-20 ">
                          <h1>In 2021</h1>
                          <div className="box_fix">
                            <p>Players Spent</p>
                            <h3><span>$198 Billion</span></h3>
                            <p>on in-game items.</p>
                          </div>
                        </div>
                        <div className="col-md-6 box box_two">
              ...
              <div className="col-xl-5 col-lg-5">
                <div className="s-about-img fix_image">
                  <img src="assets/img/images/BC_Kimono.png" alt="" />
                </div>
              </div>
            </div>
